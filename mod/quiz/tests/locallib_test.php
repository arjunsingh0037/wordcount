...
class mod_quiz_locallib_testcase extends advanced_testcase {
    ...
    public function test_quiz_get_user_timeclose() {
        ...
        $comparearray = array($quiz1->id => [
            'usertimeclose' => $basetimestamp + 10800, // The overriden timeclose for quiz 1.
            'usertimelimit' => 0
        ], $quiz2->id => [
            'usertimeclose' => $basetimestamp + 7200, // The unchanged timeclose for quiz 2.
            'usertimelimit' => 0
        ]);
        ...
        $comparearray = array($quiz1->id => [
            'usertimeclose' => $basetimestamp + 14400, // The overriden timeclose for quiz 1.
            'usertimelimit' => 0
        ], $quiz2->id => [
            'usertimeclose' => $basetimestamp + 7200, // The unchanged timeclose for quiz 2.
            'usertimelimit' => 0
        ...
        $comparearray = array($quiz1->id => [
            'usertimeclose' => $basetimestamp + 7200, // The unchanged timeclose for quiz 1.
            'usertimelimit' => 0
        ], $quiz2->id => [
            'usertimeclose' => $basetimestamp + 7200, // The unchanged timeclose for quiz 2.
            'usertimelimit' => 0
