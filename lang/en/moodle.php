...
$string['copy'] = 'copy';
$string['copyanddisplay'] = 'Copy and display';
$string['copyandreturn'] = 'Copy and return';
$string['copyasnoun'] = 'copy';
$string['copycourse'] = 'Copy a course';
$string['copycourseintro'] = 'This course will be reset and copied to the given course category.';
$string['copycourselongshort'] = 'Copy the course with {$a->fullname} and {$a->shortname}.';
$string['copycheck'] = 'Copying {$a} ?';
$string['copyingcourse'] = 'Copying {$a}';
